...
%
\solution
\input{./solutions/1/5/8/solution.tex}
...
\item Prove that the given matrix is invertible and $\vec{A}^{-1}$ has integer values.
\begin{align}
    \vec{A}=\myvec{1 & \tfrac{1}{2} &.&.&\tfrac{1}{n}\\
    \tfrac{1}{2} & \tfrac{1}{3} &.&.&\tfrac{1}{n+1}\\
    .&.&.&.&.\\.&.&.&.&.\\\tfrac{1}{n} & \tfrac{1}{n+1} &.&.&\tfrac{1}{2n-1}} \label{eq:solutions/1/5/12/eq1}
\end{align}
\solution
\input{./solutions/1/5/12/solution.tex}
\end{enumerate}
