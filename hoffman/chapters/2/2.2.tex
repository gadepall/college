...
%
\solution
\input{./solutions/2/2/1/solution.tex}
...
%
\solution
\input{./solutions/2/2/2/a/solution.tex}
\item Is $f(0) = f(1)$ a
subspace of $\vec{V}$ ?
\\
\solution
\input{./solutions/2/2/2/b/solution.tex}
\item Let $\vec{V}$ be the (real) vector space of all functions $f$
...
\\
\solution
\input{./solutions/2/2/2/c/solution.tex}
%
\item Let $\vec{V}$ be the (real) vector space of all functions $f$
...
%
\solution
\input{./solutions/2/2/7/solution.tex}
...
\\
\solution
\input{./solutions/2/2/11/a/solution.tex}
%
\end{enumerate}
